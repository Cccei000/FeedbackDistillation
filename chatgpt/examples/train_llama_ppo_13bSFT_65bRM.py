...
def launch(args):
    ...
    rm_model_tokenizer.pad_token_id=3
    ...
    reward_model = modeling_fengshenLlama_rm(
        ...
        convert_func=get_experience_convert_func(args, src_tokenizer=llama_tokenizer, dst_tokenizer=rm_model_tokenizer)
    ).eval().half().cpu()
