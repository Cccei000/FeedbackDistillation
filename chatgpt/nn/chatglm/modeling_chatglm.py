...
class SelfAttention(torch.nn.Module):
    def __init__(self, hidden_size, num_attention_heads,
                 layer_id, attention_dropout_prob, output_dropout_prob, hidden_size_per_attention_head=None, bias=True,
                 params_dtype=torch.float, position_encoding_2d=True, is_training_mode=True):
        ...
        self.training = is_training_mode
...
class GLU(torch.nn.Module):
    def __init__(self, hidden_size, output_dropout_prob, is_training_mode=True, inner_hidden_size=None,
