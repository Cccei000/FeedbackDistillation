...
MODEL_NAME=PPO_LLAMA_0418
CODE_PATH='/cognitive_comp/songzhuoyang/projects/chatgpt/chatgpt/examples/train_llama_ppo.py'
...
EXPERIENCE_ARGS="\
    ...
    --rm_minibatch_size 1 \
    --prompt_dataset_path /cognitive_comp/songzhuoyang/processed_data/mixed_ppo_dataset_0327_for_llama \
    --exp_save_path    /cognitive_comp/songzhuoyang/workspace/chatgpt/7B_rlhf/exp \
    "

MODEL_ARGS="\
    --policy_ckpt_path  /cognitive_comp/songzhuoyang/workspace/chatgpt/7B_rlhf/ckpt \
