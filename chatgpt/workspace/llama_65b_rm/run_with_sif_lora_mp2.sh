...
MODEL_NAME=RM_LLAMA_65B_0602_MP2

# 数据集地址
DATASET_PATH="/cognitive_comp/liangyuxin/datasets/RM/0602/merged_dataset"
# RM保存路径
...
RM_MODEL_PATH="/cognitive_comp/liangyuxin/workspace/chatgpt/llama_65b_hf_model_sft_79w_v2_fs_MP2"
