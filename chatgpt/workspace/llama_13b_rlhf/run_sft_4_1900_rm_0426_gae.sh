...
# 经验池保存地址
EXP_SAVE_PATH="/cognitive_comp/songzhuoyang/workspace/chatgpt/13B_rlhf/exp/$MODEL_NAME/gae/$VERSION/"

# RL过程中Policy保存路径
POLICY_CKPT_PATH="/cognitive_comp/songzhuoyang/workspace/chatgpt/13B_rlhf/ckpt/$MODEL_NAME/gae/$VERSION/"
...
mkdir /cognitive_comp/songzhuoyang/workspace/chatgpt/13B_rlhf/exp/$MODEL_NAME/gae/
mkdir /cognitive_comp/songzhuoyang/workspace/chatgpt/13B_rlhf/ckpt/$MODEL_NAME/gae/
mkdir /cognitive_comp/songzhuoyang/workspace/chatgpt/13B_rlhf/exp/$MODEL_NAME/gae/$VERSION/
mkdir /cognitive_comp/songzhuoyang/workspace/chatgpt/13B_rlhf/ckpt/$MODEL_NAME/gae/$VERSION/
