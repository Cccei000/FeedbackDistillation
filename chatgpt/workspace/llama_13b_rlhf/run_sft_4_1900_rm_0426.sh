...
MODEL_NAME=PPO_LLAMA13B_S4_1900_RM0426NEG
VERSION="0511_1751"
...
# 经验池保存地址
EXP_SAVE_PATH="/cognitive_comp/songzhuoyang/workspace/chatgpt/13B_rlhf/exp/$MODEL_NAME/pool/$VERSION/"

# RL过程中Policy保存路径
POLICY_CKPT_PATH="/cognitive_comp/songzhuoyang/workspace/chatgpt/13B_rlhf/ckpt/$MODEL_NAME/pool/$VERSION/"
...
mkdir /cognitive_comp/songzhuoyang/workspace/chatgpt/13B_rlhf/exp/$MODEL_NAME/
mkdir /cognitive_comp/songzhuoyang/workspace/chatgpt/13B_rlhf/ckpt/$MODEL_NAME/
mkdir /cognitive_comp/songzhuoyang/workspace/chatgpt/13B_rlhf/exp/$MODEL_NAME/pool/
mkdir /cognitive_comp/songzhuoyang/workspace/chatgpt/13B_rlhf/ckpt/$MODEL_NAME/pool/
mkdir /cognitive_comp/songzhuoyang/workspace/chatgpt/13B_rlhf/exp/$MODEL_NAME/pool/$VERSION/
mkdir /cognitive_comp/songzhuoyang/workspace/chatgpt/13B_rlhf/ckpt/$MODEL_NAME/pool/$VERSION/
